...
print(unigram_val_freqA.most_common(20))
print("Positive and deceptive:")
print(unigram_val_freqB.most_common(20))
print("Negative and truthful:")
print(unigram_val_freqC.most_common(20))
print("Negative and deceptive:")
print(unigram_val_freqD.most_common(20))
